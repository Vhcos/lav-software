...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${base}/diagnostico-ia-360`,                     lastModified: now, changeFrequency: "monthly",  priority: 0.7 },
    { url: `${base}/software-a-medida-ia`,                   lastModified: now, changeFrequency: "monthly",  priority: 0.7 },
