...
const planes = [
  {
    ...
    precio: "5 UF",
    sufijo: "+ IVA / mes",
    detalle: "Renovación automática mensual.",
  ...
  },
  {
    ...
    precio: "30 UF",
    sufijo: "+ IVA / 12 meses",
    detalle: "50% de descuento sobre 60 UF. Sujeto a disponibilidad al momento de contratar — limitado a las primeras 100 empresas.",
